architecture ecp5_dsp of instruction is
    ...
    signal request_calculation : std_logic := '0';
...
begin
    ...
    begin
        if rising_edge(clock) then
            ...
            ---------------
            reset_accumulator <= '0';
            CASE decode(instruction_in.instr_pipeline(work.dual_port_ram_pkg.read_pipeline_delay + 5 + g_read_delays+ g_read_out_delays)) is
                WHEN mpy_add 
                    | neg_mpy_add   
                    | neg_mpy_sub   
                    | mpy_sub
                    ...
                    , get_dest(instruction_in.instr_pipeline(work.dual_port_ram_pkg.read_pipeline_delay + 5 + g_read_delays+ g_read_out_delays))
