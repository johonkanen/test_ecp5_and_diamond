...
------------------------------------------------------------------------
        ...
        begin
            if rising_edge(clk120Mhz) then
                ...
                if adc_scan_trigger_counter < adc_scan_trigger_period-1 then
                    adc_scan_trigger_counter <= adc_scan_trigger_counter + 1;
                else
                    adc_scan_trigger_counter <= 0;
                end if;

                if adc_scan_trigger_counter = 0 then
