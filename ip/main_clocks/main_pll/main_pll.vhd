...
-- Module  Version: 5.7
--D:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n main_pll -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 50 -fclkop 120.00 -fclkop_tol 0.0 -fclkos 240.00 -fclkos_tol 0.0 -phases 0 -fclkos2 5 -fclkos2_tol 0.0 -phases2 0 -phase_cntl STATIC -fb_mode 1 -fdc C:/dev/test_ecp5_and_diamond/ip/main_clocks/main_pll/main_pll.fdc 
...
architecture Structure of main_pll is
    ...
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "5.000000";
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS2_CPHASE=>  95, CLKOS_FPHASE=>  0, CLKOS_CPHASE=>  1, 
        ...
        CLKOS2_DIV=>  96, CLKOS_DIV=>  2, CLKOP_DIV=>  4, CLKFB_DIV=>  12, 
